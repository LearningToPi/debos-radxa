...
export ARCH=arm64
export FORMAT=gpt
export IMAGESIZE=8192MB

# Add pre-installed packages for target system
cat > $BUILD_DIR/${BOARD}-${MODEL}-${DISTRO}-${VARIANT}-${ARCH}-${FORMAT}-packages.list <<EOF
linux-headers-5.10.110-1003-rockchip-g_5.10.110-1003-rockchip_arm64.deb  
linux-image-5.10.110-1003-rockchip-g-dbg_5.10.110-1003-rockchip_arm64.deb
linux-libc-dev_5.10.110-1003-rockchip_arm64.deb
linux-image-5.10.110-1003-rockchip-g_5.10.110-1003-rockchip_arm64.deb
EOF
